...
/**
 * Response to populate metrics information. Only Non null fields will be included in the response.
 * This is useful to get the same response which is defined for getting specific field metrics
 * information.
 */
